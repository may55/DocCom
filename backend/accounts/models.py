...
class UserProfile(models.Model):
    ...
    license = models.TextField(max_length=2000, blank=True, default='')
    qualification = models.TextField(max_length=2000, blank=True, default='')
    specilization = models.TextField(max_length=2000, blank=True, default='')
    profession = models.TextField(max_length=2000, blank=True, default='')
    district = models.TextField(max_length=2000, blank=True, default='')
    state = models.TextField(max_length=2000, blank=True, default='')    
